...
import Monopoly.model.dice.DiceLabel;
import Monopoly.model.dice.TwoIcon;
import Monopoly.model.player.Player;
import Monopoly.model.player.PlayerMoney;
...
public class MonopolyGame {
    ...
    public void setup() {
        ...
        Image image = new ImageIcon("Monopoly/res/startbutton.png").getImage().getScaledInstance(300, 56,
    ...
    public void PlayTurn(Player player, int result1, int result2) {
        ...
        if (result != 0) {
            ...
            notification.addNotification(player.getColor(), "                                       " + player.getName()
                    + " move " + result + " steps                                         ");
        ...
        if (player.getBalance() <= 0) {
            notification.addNotification(player.getColor(), "                          "
                    + player.getName() + " is bankrupted.                          ");
